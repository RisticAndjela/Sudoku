...
static std::string path = "puthere.txt";
...
void continueWithSolvableSudoku1(Sudoku9* chosenSudoku, bool madeByGenerator = false) {
    // User options
...
void playPreMadeSudoku1(std::string path) {
    ...
    continueWithSolvableSudoku1(chosenSudoku);
}

// Function to play a new-generated Sudoku
void playNewGeneratedSudoku1() {
    ...
    std::cout << std::endl;
    generator->getSudokuForPlayer()->outputSimpled();
    continueWithSolvableSudoku1(generator->getSudokuForPlayer(), true);
}
